...
pub fn test_continuous_array(name: &str, mut array: Vec<i32>, answer: i32) -> Box<[u8]> {
...
pub fn continuous_array_loader() {
    ...
    f.write_all(&test_continuous_array("1", vec1, 0)).expect("Failed to write to file");
    f.write_all(&test_continuous_array("2", vec2, 1)).expect("Failed to write to file");
    f.write_all(&test_continuous_array("3", vec3, 3)).expect("Failed to write to file");
    f.write_all(&test_continuous_array("4", vec4, 5)).expect("Failed to write to file");
    f.write_all(&test_continuous_array("5", vec5, 158)).expect("Failed to write to file");
    f.write_all(&test_continuous_array("6", vec6, 128)).expect("Failed to write to file");
...
pub fn big_test(mut f: File) {
    ...
    f.write_all(&test_continuous_array("BIG", vec_input, 99989)).expect("Failed to write to file");
}
